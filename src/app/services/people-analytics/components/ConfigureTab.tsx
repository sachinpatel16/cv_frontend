...
export function ConfigureTab({
  ...
  return (
    <div className="flex h-full flex-col justify-between space-y-6 overflow-hidden rounded-xl border border-[#1E3048] bg-[#0D1628] p-6 shadow-2xl">
      ...
      {/* Video Drawing Canvas Area (No nesting borders/boxes) */}
      ...
      {/* Queue List (Simple, minimal style) */}
      ...
      {/* Sliders (Simple grid, no card borders or nested cards) */}
      {showThresholds && (
        <div className="grid grid-cols-1 gap-6 border-t border-[#1E3048]/60 pt-5 md:grid-cols-2">
