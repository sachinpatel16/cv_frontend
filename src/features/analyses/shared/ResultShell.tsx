...
export type ResultTab = 'results' | 'timeline' | 'raw';

// Context to expose active tab to child result components
const ResultTabContext = createContext<ResultTab>('results');

export function useResultTab() {
  return useContext(ResultTabContext);
}
...
export function ResultShell({
  ...
  return (
    <ResultTabContext.Provider value={activeTab}>
